...
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
control.ButtonBankResetHard = Part.Control.Bank.ButtonBank:new()

function control.ButtonBankResetHard:new(o, handler, text)
...
function control.ButtonBankResetHard:getOutputText()
...
function control.ButtonBankResetHard:submit()
...
function control.ButtonBankResetHard:action()
