...
Part.Gui.Tab.tab_tcp = Part.Tab.Entry.TabEntry:new(nil, Part.Gui.Tab.tab_top, "Arrange")
Part.Gui.Tab.tab_mcp = Part.Tab.Entry.TabEntry:new(nil, Part.Gui.Tab.tab_top, "Mixer")
...
Part.Gui.Tab.tab_colors_tracks = Part.Tab.EntrySub.TabEntrySub:new(nil, Part.Gui.Tab.tab_colors_sub, "Tracks / Envelopes")
Part.Gui.Tab.tab_colors_meter = Part.Tab.EntrySub.TabEntrySub:new(nil, Part.Gui.Tab.tab_colors_sub, "Meter / Folders")
...
Part.Cursor.setCursorPos(40, Part.Global.win_h - Part.Cursor.getCursorH())
Part.Cursor.stackCursor()
Part.Gui.BankBar = Part.Layout.BankBar.BankBar:new(nil, Part.Bank.Handler)
Part.Cursor.destackCursor()

-- config bar
Part.Cursor.setCursorPos(300, Part.Global.win_h - Part.Cursor.getCursorH())
...
Part.Cursor.setCursorPos(705, Part.Global.win_h - Part.Cursor.getCursorH() - 10)
...
-- theme files
Part.Gui.Macros.drawGroupBox("Theme", group_x, group_y, group_w_wide, 100)
...
-- apply-to-all button
Part.Cursor.incCursor(0, 10, 0, 0)
Part.Cursor.setCursorSize(200, nil)
...
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_track_bg_tone, false, slider_w,
    "BG Tone", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_track_background_tone, slider,
    true)
Part.Gui.Macros.nextLine()
...
Part.Gui.Macros.placeCursorAtLastGroup(true, true, true)
...
-- ===========================================================================
--      Tab : Colors : Meter / Folders
-- ===========================================================================

-- Settings
-- ------------------------------

Part.Tab.Entry.setRecentTab(Part.Gui.Tab.tab_colors_meter)
Part.Gui.Macros.resetCursor()
local group_x = Part.Cursor.getCursorX()
local group_y = Part.Cursor.getCursorY()
...
-- unlit alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_unlit, false,
    slider_w, "Unlit Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_text_unlit_alpha, slider,
    true)
Part.Gui.Macros.nextLine()
...
-- lit alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_lit, false,
    slider_w, "Lit Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_text_lit_alpha, slider,
    true)
Part.Gui.Macros.nextLine()
...
-- track alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_track, false,
    slider_w, "Track Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_text_track_alpha, slider,
    true)
Part.Gui.Macros.nextLine()

-- master alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_master, false,
    slider_w, "Master Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_text_master_alpha, slider,
    true)
Part.Gui.Macros.nextLine()
Part.Gui.Macros.nextSection(section_w)
...
-- readout alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_readout, false,
    slider_w, "Readout Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_readout_alpha, slider,
    true)
Part.Gui.Macros.nextLine()
...
-- readout clip alpha
slider = Part.Gui.Macros.drawSliderGroup(true, Part.Parameter.Map.par_colors_track_meter_text_alpha_readout_clip,
    false, slider_w, "Clip Alpha", label_w)
Part.Control.Hint.Hint:new(nil, Part.Gui.Hint.Lookup.colors_meter_readout_clip_alpha, slider,
    true)
Part.Gui.Macros.nextLine()
...
group_x = Part.Cursor.getCursorX()
group = Part.Gui.Macros.drawGroupBox("Folders", group_x, group_y, group_w, 180)
...
-- Button Wrapping
local selection = {
    { label = "Full",    value = 1, width = 35 },
    { label = "Tight",   value = 2, width = 40 },
    { label = "Tight +", value = 3, width = 40 }
}
...
-- definition
local parameters = {
    Part.Parameter.Map.par_user_range_0,
    Part.Parameter.Map.par_user_range_1,
    Part.Parameter.Map.par_user_range_2,
    Part.Parameter.Map.par_user_range_3,
    Part.Parameter.Map.par_user_range_4,
    Part.Parameter.Map.par_user_range_5,
    Part.Parameter.Map.par_user_range_6,
    Part.Parameter.Map.par_user_range_7,
    Part.Parameter.Map.par_user_range_8,
    Part.Parameter.Map.par_user_range_9,
    Part.Parameter.Map.par_user_range_10,
    Part.Parameter.Map.par_user_range_11,
    Part.Parameter.Map.par_user_range_12,
    Part.Parameter.Map.par_user_range_13,
    Part.Parameter.Map.par_user_range_14,
    Part.Parameter.Map.par_user_range_15,
}
...
for idx, parameter in pairs(parameters) do
    ...
    -- slider
    slider = Part.Gui.Macros.drawSliderGroup(true, parameter, false, slider_w, label_name, label_w)
...
Part.Gui.Macros.placeCursorAtLastGroup(true, false, true)
group_x = Part.Cursor.getCursorX()
Part.Gui.Macros.drawGroupBox("Custom Selections", group_x, group_y, group_w, 210)

-- definition
local parameters = {
    Part.Parameter.Map.par_user_selection_0,
    Part.Parameter.Map.par_user_selection_1,
    Part.Parameter.Map.par_user_selection_2,
    Part.Parameter.Map.par_user_selection_3,
    Part.Parameter.Map.par_user_selection_4,
    Part.Parameter.Map.par_user_selection_5,
    Part.Parameter.Map.par_user_selection_6,
    Part.Parameter.Map.par_user_selection_7,
}
...
for idx, parameter in pairs(parameters) do
    ...
    -- button
    button = Part.Gui.Macros.drawButtonSelectionGroup(true, parameter, false, selection, label_name, label_w)
...
-- definition
local parameters = {
    Part.Parameter.Map.par_user_switch_0,
    Part.Parameter.Map.par_user_switch_1,
    Part.Parameter.Map.par_user_switch_2,
    Part.Parameter.Map.par_user_switch_3,
    Part.Parameter.Map.par_user_switch_4,
    Part.Parameter.Map.par_user_switch_5,
    Part.Parameter.Map.par_user_switch_6,
    Part.Parameter.Map.par_user_switch_7,
}
...
for idx, parameter in pairs(parameters) do
    ...
    -- button
    button = Part.Gui.Macros.drawButtonToggleGroup(true, parameter, 100, label_name, "On", label_w)
